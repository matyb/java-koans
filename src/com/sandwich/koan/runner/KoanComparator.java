...
public class KoanComparator implements Comparator<KoanMethod> {
	...
	public KoanComparator(String csvKeywords){
		this(csvKeywords.split(","));
	}
	
	public KoanComparator(String...orderedKeywords) {
		 this.orderedKeywords = new ArrayList<String>();
		 for(String keyword : orderedKeywords){
			 this.orderedKeywords.add(keyword.trim());
		 }
