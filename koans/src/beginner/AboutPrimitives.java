...
public class AboutPrimitives {
    ...
    public void longsHaveALargerRangeThanInts() {
        assertEquals(Long.MIN_VALUE, Long.valueOf(-9223372036854775808l));
        assertEquals(Long.MAX_VALUE, Long.valueOf(9223372036854775807l));
    }
    ...
    public void primitivesOfTypeDoubleCanBeDeclaredWithExponents() {
        ...
        assertEquals(1.0e3, 1000.00);
        assertEquals(1E3, 1000.00);
    }
