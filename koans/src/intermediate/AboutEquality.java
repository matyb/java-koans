...
public class AboutEquality {
    ...
    static class Car {
        ...
        public boolean equals(Object other) {
            ...
            return Objects.equals(this.name, otherCar.name) && this.horsepower == otherCar.horsepower;
        }

        @Override
        public int hashCode() {
            // @see http://download.oracle.com/javase/6/docs/api/java/lang/Object.html#hashCode()
            return Objects.hashCode(this.horsepower) * 31 + Integer.hashCode(horsepower);
        }
    }
